// bind() also takes additional parameters that become arguments when invoking
// the target function. You can use this to curry (https://en.wikipedia.org/wiki/Currying)
// functions. 
//
